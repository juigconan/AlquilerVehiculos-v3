...
public class Controles {
	...
	// Pongo este metodo y esta interfaz funcional para ahorrar codigo en futuras
	// ventanas
	public static void validarConEnter(Confirmar confirmar, TextField... campos) {
		for (TextField campo : campos) {
			campo.setOnKeyReleased(confirmar::confirmar);
		}
	}

	public interface Confirmar {
		void confirmar(KeyEvent e);
	}
